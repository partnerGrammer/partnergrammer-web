...
<template>
    <div class="container">
        ...
        <section class="main-container" >
            <!-- seccion 1 -->
            <section class="row">
                <div class="col-md-6 wow animate__animated animate__fadeInLeft" style="max-width: 40%">
                    <img src="/images/partner.png" width="100%" alt="">
                </div>
                <div class="col-md-6 d-flex justify-content-start align-items-center flex-column wow animate__animated animate__fadeInRight" id="banner-texto">
